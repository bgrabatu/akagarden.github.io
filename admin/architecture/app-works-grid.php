        ...
        <div id="content" class="main-content">
            ...
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <!-- BREADCRUMB -->
                    <div class="page-meta " style="margin-bottom:20px">
                    ...
                    <div class="row">
                        ...
                        ?>
                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-4 col-sm-6 mb-4">
                                    <a href="app-works-post.php?projectDetails=<?php echo $data['project_id']; ?>" class="card style-2 mb-md-0 mb-4">
                                        <img src="<?php echo $data['project_main_image']; ?>" class="card-img-top" alt="...">
                                        <div class="card-body px-0 pb-0">
                                            <h5 class="card-title mb-3"><?php echo $data['project_name']; ?></h5>
                                            <p><?php echo $data['project_short_description']; ?></p>
                                            <div class="media mt-4 mb-0 pt-1">
                                                <img src="../src/assets/img/profile-5.jpeg" class="card-media-image me-3" alt="">
                                                <div class="media-body">
                                                    <h4 class="media-heading mb-1"><?php echo $data['project_meta_author']; ?></h4>
                                                    <p class="media-text"><?php echo $data['project_date_time']; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </a>
