...
<head>
    ...
    <title>Admin Panel | LockScreen | Elba Safety Automation </title>
                ...
                <div class="col-6 d-lg-flex d-none h-100 my-auto top-0 start-0 text-center justify-content-center flex-column">
                    ...
                    <div class="auth-cover">
                        ...
                        <div class="position-relative">
                            ...
                            <h2 class="mt-5 text-white font-weight-bolder px-2">Invest in Safety, Experience the Difference with Elba Safety Automation.</h2>
                            <p class="text-white px-2">Elba Safety Automation is a pioneer in emphasizing the importance of investing in safety in the industrial sector.</p>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="media mb-4">
                                        ...
                                        <div class="media-body align-self-center">
                                            ...
                                            <h3 class="mb-0">Elba Safety Automation</h3>
                                ...
                                <form action="lockscreen.php" method="POST">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            <button class="btn btn-secondary w-100" name="unlock">UNLOCK</button>
                                        </div>
                                    </div>
                                </form>
