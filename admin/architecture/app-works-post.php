...
$project_type = $editDataProject['project_type'];
if ($editDataProject['project_type'] == "IcMekanTasarimi") {
    $project_type = "İç Mekan Tasarımı";
} else if ($editDataProject['project_type'] == "DisMekanTasarimi") {
    $project_type = "Dış Mekan Tasarımı";
} else if ($editDataProject['project_type'] == "MimariDanismanlik") {
...
<head>
    ...
    <title>Admin Panel | Works | Elba Safety Automation </title>
                    ...
                    <div class="row layout-top-spacing">
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-4">
                            <div class="single-post-content">
                                <div class="featured-image" style="background: url('<?php echo $editDataProject['project_main_image']; ?>'); no-repeat; fixed; center; ">
                                    <div class=" featured-image-overlay"></div>

                                    <div class="post-header">

                                        <div class="post-title">
                                            <h5 class="mb-0" style="color: white;"><?php echo $project_type ?? ''; ?></h5>
                                            <h1 class="mb-0"><?php echo $editDataProject['project_name'] ?? ''; ?></h1>
                                        </div>

                                        <div class="post-meta-info d-flex justify-content-between">

                                            <div class="media">
                                                <img src="../src/assets/img/profile-23.jpeg" alt="profile">
                                                <div class="media-body">
                                                    <h5><?php echo $editDataProject['project_meta_author'] ?? ''; ?></h5>
                                                    <p><?php echo $editDataProject['project_date_time'] ?? ''; ?></p>
                                                </div>
                                            </div>

                                            <div class="align-self-center">
                                                <a href="app-works-post.php?deleteProject=<?php echo $editDataProject['project_id']; ?>" class="btn btn-danger btn-icon btn-share btn-rounded">
                                                    <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                                        <g id="SVGRepo_iconCarrier">
                                                            ...
                                                            <path d="M4 16L8.29289 11.7071C8.68342 11.3166 9.31658 11.3166 9.70711 11.7071L13 15M13 15L15.7929 12.2071C16.1834 11.8166 16.8166 11.8166 17.2071 12.2071L20 15M13 15L15.25 17.25" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                            <path d="M17 3L19 5M21 7L19 5M19 5L21 3M19 5L17 7" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                                        </g>
                                                    </svg>
                                                </a>
                                            </div>
                                ...
                                <div class="post-content">
                                    ...
                                    <p class="mb-5"><?php echo $editDataProject['project_short_description'] ?></p>
                                    <h4><?php echo $editDataProject['project_short_description'] ?></h4>

                                    <p class="mb-4"><?php echo $editDataProject['project_result_description'] ?></p>

                                    <div class="image-container">
                                        <img src="<?php echo $editDataProject['project_detail_image_1'] ?>" alt="image-1" class="full-width img-fluid">
                                    </div>
                                    <div class="image-container">
                                        <img src="<?php echo $editDataProject['project_detail_image_2'] ?>" alt="image-2" style="padding-right:10px" class="half-width img-fluid mt-4 mb-5">
                                        <img src="<?php echo $editDataProject['project_detail_image_3'] ?>" alt="image-3" style="padding-left:10px" class="half-width img-fluid mt-4 mb-5">
                                    </div>
                                    <div class="image-container">
                                        <img src="<?php echo $editDataProject['project_detail_image_4'] ?>" alt="image-1" class="full-width img-fluid">
                                    </div>
                                    <div class="image-container">
                                        <img src="<?php echo $editDataProject['project_detail_image_5'] ?>" alt="image-2" style="padding-right:10px" class="half-width img-fluid mt-4 mb-5">
                                        <img src="<?php echo $editDataProject['project_detail_image_6'] ?>" alt="image-3" style="padding-left:10px" class="half-width img-fluid mt-4 mb-5">
                                    </div>

                                    <div style="padding-left: 50px; border-left: 2px solid black;">
                                        <p style=" width: 50%; font-size: 13px;"><?php echo $editDataProject['project_meta_keywords'] ?></p>
                                        <p style=" width: 50%; font-size: 18px;"><?php echo $editDataProject['project_meta_description'] ?></p>
                                        <p style="font-weight: bold; font-size: 19px;"><?php echo $editDataProject['project_meta_author'] ?></p>
                                        <p class="mb-5" style="font-size: 14px;"><?php echo $editDataProject['project_meta_title'] ?></p>
                                    </div>
