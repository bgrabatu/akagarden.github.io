...
<head>
    ...
    <title>Admin Panel | Works Edit | Elba Safety Automation </title>
        ...
        <div id="content" class="main-content">
            ...
            <div class="layout-px-spacing">
                ...
                <div class="middle-content container-xxl p-0">
                    ...
                    <form action="app-works-edit.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4 layout-spacing layout-top-spacing">
                            <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="widget-content widget-content-area blog-create-section">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="project_name" id="post-title" placeholder="Project Name" value="<?php echo $dataEditingProject['project_name'] ?>">
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            <input type="hidden" class="form-control" name="project_id" id="post-title" value="<?php echo $dataEditingProject['project_id'] ?>">
                                        </div>
                                    </div>

                                    <div class="input-group mb-4">
                                        <span class="input-group-text bg-white">Project Short Description</span>
                                        <textarea class="form-control" style="height: 150px;" name="project_short_description" aria-label="Project Short Description"><?php echo $dataEditingProject['project_short_description'] ?></textarea>
                                    </div>

                                    <div class="input-group mb-4">
                                        <span class="input-group-text bg-white">Project Description</span>
                                        <textarea class="form-control" style="height: 150px;" name="project_description" aria-label="Project Description"><?php echo $dataEditingProject['project_description'] ?></textarea>
                                    </div>

                                    <div class="input-group mb-4">
                                        <span class="input-group-text bg-white">Project Result <br>Description</span>
                                        <textarea class="form-control" style="height: 150px;" name="project_result_description" aria-label="Project Result Description"><?php echo $dataEditingProject['project_result_description'] ?></textarea>
                                    </div>

                                    <div class="input-group mb-4">
                                        <span class="input-group-text bg-white">Project Tags</span>
                                        <textarea class="form-control" style="height: 150px;" name="project_tags" aria-label="Project Tags"><?php echo $dataEditingProject['project_tags'] ?></textarea>
                                    </div>

                                    <div class="input-group mb-4">
                                        <select class="form-select" id="project_type" name="project_type">
                                            <option value="">Project Type Chose</option>
                                            <option value="IcMekanTasarimi" <?php echo ($dataEditingProject['project_type'] === 'IcMekanTasarimi') ? 'selected' : ''; ?>>İç Mekan Tasarımı</option>
                                            <option value="DisMekanTasarimi" <?php echo ($dataEditingProject['project_type'] === 'DisMekanTasarimi') ? 'selected' : ''; ?>>Dış Mekan Tasarımı</option>
                                            <option value="MimariDanismanlik" <?php echo ($dataEditingProject['project_type'] === 'MimariDanismanlik') ? 'selected' : ''; ?>>Mimari Danışmanlık</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="widget-content widget-content-area blog-create-section mt-4">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-xxl-12 mb-4">
                                            <input type="text" class="form-control" id="post-meta-title" name="project_meta_title" placeholder="Work Meta Title" value="<?php echo $dataEditingProject['project_meta_title'] ?>">
                                        </div>
                                        <div class="col-xxl-12 mb-4">
                                            <input type="text" class="form-control" id="post-meta-title" name="project_meta_author" placeholder="Work Meta Author" value="<?php echo $dataEditingProject['project_meta_author'] ?>">
                                        </div>
                                        <div class="input-group mb-4">
                                            <span class="input-group-text bg-white">Work Meta Description</span>
                                            <textarea class="form-control" name="project_meta_description" aria-label="Work Long Title"><?php echo $dataEditingProject['project_meta_description'] ?></textarea>
                                        </div>

                                        <div class="input-group mb-4">
                                            <span class="input-group-text bg-white">Work Meta Keywords</span>
                                            <textarea class="form-control" name="project_meta_keywords" aria-label="Work Long Title"><?php echo $dataEditingProject['project_meta_keywords'] ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="widget-content widget-content-area blog-create-section mt-4">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <?php if ($dataEditingProject['project_main_image'] == 'project_photos/' || empty($dataEditingProject['project_main_image'])) : ?>
                                                <p style="margin-top:20px"> There are no photos in this project!</p>
                                            <?php else : ?>
                                                <img src="<?php echo $dataEditingProject['project_main_image'] ?>" alt="" height="70%" width="70%" style="margin-top: 20px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <?php if ($dataEditingProject['project_detail_image_1'] == 'project_photos/' || empty($dataEditingProject['project_detail_image_1'])) : ?>
                                                <p style="margin-top:20px"> There are no photos in this project!</p>
                                            <?php else : ?>
                                                <img src="<?php echo $dataEditingProject['project_detail_image_1'] ?>" alt="" height="70%" width="70%" style="margin-top: 20px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <?php if ($dataEditingProject['project_detail_image_2'] == 'project_photos/' || empty($dataEditingProject['project_detail_image_2'])) : ?>
                                                <p style="margin-top:20px"> There are no photos in this project!</p>
                                            <?php else : ?>
                                                <img src="<?php echo $dataEditingProject['project_detail_image_2'] ?>" alt="" height="70%" width="70%" style="margin-top: 20px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <?php if ($dataEditingProject['project_detail_image_3'] == 'project_photos/' || empty($dataEditingProject['project_detail_image_3'])) : ?>
                                                <p style="margin-top:20px"> There are no photos in this project!</p>
                                            <?php else : ?>
                                                <img src="<?php echo $dataEditingProject['project_detail_image_3'] ?>" alt="" height="70%" width="70%" style="margin-top: 20px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <?php if ($dataEditingProject['project_detail_image_4'] == 'project_photos/' || empty($dataEditingProject['project_detail_image_4'])) : ?>
                                                <p style="margin-top:20px"> There are no photos in this project!</p>
                                            <?php else : ?>
                                                <img src="<?php echo $dataEditingProject['project_detail_image_4'] ?>" alt="" height="70%" width="70%" style="margin-top: 20px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <?php if ($dataEditingProject['project_detail_image_5'] == 'project_photos/' || empty($dataEditingProject['project_detail_image_5'])) : ?>
                                                <p style="margin-top:20px"> There are no photos in this project!</p>
                                            <?php else : ?>
                                                <img src="<?php echo $dataEditingProject['project_detail_image_5'] ?>" alt="" height="70%" width="70%" style="margin-top: 20px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <?php if ($dataEditingProject['project_detail_image_6'] == 'project_photos/' || empty($dataEditingProject['project_detail_image_6'])) : ?>
                                                <p style="margin-top:20px"> There are no photos in this project!</p>
                                            <?php else : ?>
                                                <img src="<?php echo $dataEditingProject['project_detail_image_6'] ?>" alt="" height="70%" width="70%" style="margin-top: 20px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <?php if ($dataEditingProject['project_small_image'] == 'project_photos/' || empty($dataEditingProject['project_small_image'])) : ?>
                                                <p style="margin-top:20px"> There are no photos in this project!</p>
                                            <?php else : ?>
                                                <img src="<?php echo $dataEditingProject['project_small_image'] ?>" alt="" height="70%" width="70%" style="margin-top: 20px;">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-12 mb-4">
                                            <div class="switch form-switch-custom switch-inline form-switch-primary">
                                                <input class="switch-input" type="checkbox" role="switch" name="project_display_status" id="showPublicly" <?php echo ($dataEditingProject['project_display_status'] == 1) ? 'checked' : ''; ?>>
                                                <label class="switch-label" for="showPublicly">Publish</label>
                                            </div>
                                        </div>
                                        <div class="col-xxl-12 mb-4">
                                            <div class="switch form-switch-custom switch-inline form-switch-primary">
                                                <input class="switch-input" type="checkbox" role="switch" name="project_enable_comment" id="enableComment" <?php echo ($dataEditingProject['project_enable_comment'] == 1) ? 'checked' : ''; ?>>
                                                <label class="switch-label" for="enableComment">Enable Comments</label>
                                            </div>
                                        </div>

                                        <div class="col-xxl-12 col-sm-4 col-12 mx-auto">
                                            <button class="btn btn-success w-100" name="update-post">Update Post</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
